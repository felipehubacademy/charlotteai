    ...
    try {
      ...
      setError(
        msg.includes('different from the old password')
          ? (isPt ? 'A nova senha deve ser diferente da senha temporária.' : 'The new password must be different from the temporary one.')
        ...
        >
          ...
          <View style={{ alignItems: 'center', marginBottom: 36 }}>
            ...
            <AppText style={{ fontSize: 14, color: C.navyMid, marginTop: 8, textAlign: 'center', lineHeight: 20 }}>
              {isPt ? <>É seu primeiro acesso.{'\n'}Defina uma senha pessoal para continuar.</> : <>This is your first login.{'\n'}Set a personal password to continue.</>}
            </AppText>
          </View>
