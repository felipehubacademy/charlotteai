# Module M24 — Reagindo na conversa

> **Level**: Novice (A2)
> **Block**: A2 Survival
> **Units**: 5 (N01–N05)
> **Theme**: Reações curtas conversacionais — destravar o aluno em conversas reais com chunks de alta frequência.
> **Module goal**: Aluno reage naturalmente em conversação (não fica mudo enquanto pensa o que dizer) usando reações de alta frequência.
> **Connects to**: I23 (fillers Inter expandem isso) e A21 (native fluency Advanced).

## Module chunks introduced (~30)

- Cool / Sweet / Awesome / Nice
- Right / Got it / Sure / Okay
- No way! / Get out! / For real? / Seriously? / Are you kidding?
- Hold on / Hang on / Wait / Hold up
- Really? / Oh yeah? / Is that so?
- Bummer / That sucks / Oh no
- Whatever / Never mind / No biggie
- I see / I know / I get it / Makes sense
- Same here / Me too / Me neither
- Oh! / Hmm / Yeah... (sons de acknowledgment)
...
> **Sub-CEFR**: A2 | **Grammar focus**: Reações para mostrar engajamento na conversa
...
1. **multiple_choice** — Alguém diz "I'm going to Paris next month." Reação que mostra interesse:
   **Options**: Really? / Bad. / Whatever. / No.
   **Answer**: Really?
   **Explanation**: "Really?" — reação de interesse genuíno, convida o falante a continuar. As outras opções fecham a conversa ou são negativas. "Really?" é o filler de interesse mais comum.
...
1. **"Really?"** — reação curta de interesse
2. **"Tell me more!"** — pedido de continuação
3. **"That's interesting!"** — reação positiva
4. **"Oh yeah?"** — interesse casual
5. **"That sounds amazing!"** — reação entusiasmada

### 3. Role-play

**Cenário**: Charlotte conta sobre algo interessante que aconteceu com ela. Você reage para mostrar interesse e pedir detalhes.
**Tipo**: Live Voice
**Voiced by**: `charlotte`
**Persona**: Charlotte
**Persona outfit**: `charlotte_casual`
**Time budget**: 90s
**Opening line**: "I have some exciting news — I just got accepted to study abroad next year!"

**Sub-objectives** (3 objetivos):

1. **id**: 1
   **label_pt**: "Reagir positivamente"
   **label_en**: "React positively"
...
3. **id**: 3
   ...
   **label_en**: "React with positive surprise"
...
1. **Charlotte**: "I have some exciting news — I just got accepted to study abroad next year!"
2. **Student**: ~"That's amazing!"
3. **Charlotte**: "Thank you! It's in Portugal — I leave in September."
4. **Student**: ~"Tell me more!"
5. **Charlotte**: "I'll study Portuguese literature for a full year. I'm so nervous and excited."
6. **Student**: ~"Really? That sounds incredible!"
7. **Charlotte**: "Right? I can't believe it's happening. Thanks for listening!"

**Evaluation focus**:
- Reações naturais sem ficar mudo
- Mostrar engajamento na história
- Pedir continuação

### 4. Guided Chat

**Cenário**: Charlotte conta uma história e quer ver você reagindo naturalmente.
**Voiced by**: `charlotte`
**Persona**: Charlotte
**Persona outfit**: `charlotte_casual`
**Intro (em PT-BR)**: "Charlotte te conta uma história — reaja com naturalidade. Não fique mudo!"
**Opening message**: "Last weekend something weird happened to me at the supermarket..."

**Sub-objectives** (3 objetivos):

1. **id**: 1
   **label_pt**: "Reagir com 'Really?' ou 'Oh yeah?'"
   **label_en**: "React with 'Really?' or 'Oh yeah?'"
...
> **Sub-CEFR**: A2 | **Grammar focus**: Reações de surpresa, espanto, descrença
> **Markers**: [conversation]
> **Real-life context**: Alguém te conta algo inesperado ou incrível e você quer reagir com força.

### 1. Grammar (10 exercises)

1. **multiple_choice** — Alguém diz "I won the lottery!" Reação de surpresa:
   **Options**: No way! / Cool. / OK. / Sure.
   **Answer**: No way!
   **Explanation**: "No way!" — reação de surpresa intensa. Chunk fixo de descrença ou choque positivo. "Cool" / "OK" / "Sure" são reações neutras demais para uma notícia extraordinária.

2. **multiple_choice** — "I just met Beyoncé!" Reação de descrença:
   **Options**: Seriously? / Yeah. / Right. / Maybe.
   **Answer**: Seriously?
   **Explanation**: "Seriously?" — reação de descrença. Pergunta se a pessoa está falando sério. Sinônimos: "Are you kidding?" / "For real?".
...
5. **fill_gap** — "_____ real?"
   **Hint**: preposição
   **Answer**: For
   **Explanation**: "For real?" — chunk fixo de descrença casual. Significa "isso é real?" / "é sério?". Variação informal de "Seriously?".
...
10. **read_answer**
    ...
    **Question**: How does the speaker react to the engagement news?
...
1. **"No way!"** — descrença/surpresa forte
2. **"Seriously?"** — descrença verificadora
3. **"You're kidding!"** — "tá brincando!"
4. **"For real?"** — "é sério?"
5. **"Get out!"** — surpresa chocada (casual)

### 3. Role-play

**Cenário**: Charlotte te conta três notícias inesperadas. Você reage com surpresa apropriada.
**Tipo**: Live Voice
**Voiced by**: `charlotte`
**Persona**: Charlotte
**Persona outfit**: `charlotte_casual`
**Time budget**: 90s
**Opening line**: "I have three pieces of crazy news. First — I'm moving to Australia next month!"

**Sub-objectives** (3 objetivos):

1. **id**: 1
   **label_pt**: "Surpresa com 'No way!' ou 'Seriously?'"
   **label_en**: "Surprise with 'No way!' or 'Seriously?'"
...
2. **id**: 2
   ...
   **label_en**: "Disbelief with 'You're kidding!' or 'For real?'"
...
3. **id**: 3
   ...
   **label_en**: "React to the third news"
...
1. **Charlotte**: "I have three pieces of crazy news. First — I'm moving to Australia next month!"
2. **Student**: ~"No way! Seriously?"
3. **Charlotte**: "Totally serious! Second — I'm starting my own business there."
4. **Student**: ~"You're kidding!"
5. **Charlotte**: "Nope. And third — I just got married last weekend, secretly."
6. **Student**: ~"Get out! That's incredible!"
7. **Charlotte**: "Right?! I told you it was crazy!"

**Evaluation focus**:
- Reações variadas de surpresa
- Naturalidade na descrença
- Engajamento emocional

### 4. Guided Chat

**Cenário**: Charlotte testa suas reações de surpresa com várias notícias bombásticas.
**Voiced by**: `charlotte`
**Persona**: Charlotte
**Persona outfit**: `charlotte_casual`
**Intro (em PT-BR)**: "Charlotte vai te surpreender com notícias inesperadas. Reaja com naturalidade!"
**Opening message**: "Did you hear? My neighbor's dog won a national competition!"

**Sub-objectives** (3 objetivos):

1. **id**: 1
   **label_pt**: "Reação de surpresa"
   **label_en**: "Surprise reaction"
...
1. **Charlotte**: "Did you hear? My neighbor's dog won a national competition!"
2. **Student**: "No way! Really?"
3. **Charlotte**: "Yes! He's some kind of agility champion now."
4. **Student**: "What kind of competition?"
5. **Charlotte**: "Dog agility — jumping over things, running through tunnels."
6. **Student**: "That's awesome!"
7. **Charlotte**: "I know! Cool story, right?"
...
> **Sub-CEFR**: A2 | **Grammar focus**: Confirmar que entendeu, mostrar que está acompanhando
> **Markers**: [conversation]
> **Real-life context**: Alguém te explica algo e você quer confirmar que entendeu sem interromper.

### 1. Grammar (10 exercises)

1. **multiple_choice** — Alguém te explica algo complicado. Reação de entendimento:
   **Options**: Got it. / What? / I don't know. / Bad.
   **Answer**: Got it.
   **Explanation**: "Got it." — chunk fixo de confirmação. Significa "entendi". As outras opções mostram confusão ou desinteresse, não confirmação.

2. **multiple_choice** — "First, click the button. Then, enter your password." Reação:
   **Options**: Makes sense. / Whatever. / No. / Boring.
   **Answer**: Makes sense.
   **Explanation**: "Makes sense." — confirmação de que algo é lógico. Chunk fixo. Reage a explicações dizendo "faz sentido". "Whatever" mostra desinteresse.

3. **word_bank** — "I _____ what you mean."
   **Choices**: see / know / find / guess
   **Answer**: see
   **Explanation**: "I see what you mean" — chunk fixo de confirmação cognitiva. "See" aqui não é literal ("ver") — é "entender, compreender". Idiomático.

4. **word_bank** — "_____ , I understand."
   **Choices**: Right / Yes / Sure / All correct
   **Answer**: Right
...
7. **fill_gap** — "_____ you said is clear."
   ...
   **Answer**: What
   **Explanation**: "What you said is clear" — "what" como pronome relativo ("aquilo que"). Estrutura comum em confirmação.
...
10. **read_answer**
    ...
    **Question**: How does the speaker confirm understanding?
...
1. **"Got it."** — confirmação curta
2. **"Makes sense."** — algo é lógico
3. **"I see what you mean."** — entendimento de ponto
4. **"Right, I understand."** — confirmação completa
5. **"I get it."** — confirmação casual

### 3. Role-play

**Cenário**: Charlotte te explica como usar um aplicativo. Você precisa confirmar entendimento em cada passo.
**Tipo**: Live Voice
**Voiced by**: `charlotte`
**Persona**: Charlotte
**Persona outfit**: `charlotte_casual`
**Time budget**: 90s
**Opening line**: "Let me show you how this app works. First, you open it and sign in."

**Sub-objectives** (3 objetivos):

1. **id**: 1
   **label_pt**: "Confirmar com 'Got it' ou 'Okay'"
   **label_en**: "Confirm with 'Got it' or 'Okay'"
...
2. **id**: 2
   ...
   **label_en**: "Confirm with 'Makes sense'"
...
3. **id**: 3
   ...
   **label_en**: "Confirm with 'I see' or 'Right'"
...
1. **Charlotte**: "Let me show you how this app works. First, you open it and sign in."
2. **Student**: ~"Got it."
3. **Charlotte**: "Then you tap the plus button to add a new entry."
4. **Student**: ~"Makes sense."
5. **Charlotte**: "Finally, you save and it syncs automatically."
6. **Student**: ~"Right, I understand."
7. **Charlotte**: "You're a quick learner!"

**Evaluation focus**:
- Confirmações variadas
- Não fica mudo entre instruções
- Mostra acompanhamento ativo

### 4. Guided Chat

**Cenário**: Charlotte te explica algo passo a passo. Você confirma cada parte.
**Voiced by**: `charlotte`
**Persona**: Charlotte
**Persona outfit**: `charlotte_casual`
**Intro (em PT-BR)**: "Charlotte te explica algo. Confirme que está entendendo sem ficar em silêncio."
**Opening message**: "I'll teach you my recipe for the perfect coffee. First, you grind the beans fresh."

**Sub-objectives** (3 objetivos):

1. **id**: 1
   **label_pt**: "Confirmar primeira instrução"
   **label_en**: "Confirm first instruction"
...
2. **id**: 2
   ...
   **label_en**: "Confirm with 'makes sense' or 'right'"
...
3. **id**: 3
   ...
   **label_en**: "Summarize what you understood"
...
1. **Charlotte**: "I'll teach you my recipe for the perfect coffee. First, you grind the beans fresh."
2. **Student**: "Got it. Fresh beans."
3. **Charlotte**: "Then you use water at 96 degrees — not boiling."
4. **Student**: "Makes sense."
5. **Charlotte**: "Brew for four minutes, then drink slowly."
6. **Student**: "So I grind, brew, wait, drink. Got it!"
7. **Charlotte**: "Exactly! Now go make some great coffee!"
...
> **Sub-CEFR**: A2 | **Grammar focus**: Empatia, condolências leves, reações a notícias ruins
> **Markers**: [conversation]
> **Real-life context**: Alguém te conta uma notícia ruim e você quer reagir com empatia sem soar frio.

### 1. Grammar (10 exercises)

1. **multiple_choice** — Alguém diz "I lost my job last week." Reação:
   **Options**: Oh no, that sucks. / Cool. / Whatever. / OK.
   **Answer**: Oh no, that sucks.
   **Explanation**: "Oh no, that sucks" — reação empática a más notícias. "That sucks" significa "isso é péssimo". As outras opções mostram desinteresse ou indiferença.
...
3. **word_bank** — "_____ no, that's terrible!"
   **Choices**: Oh / Ah / Eh / Ow
   **Answer**: Oh
   **Explanation**: "Oh no!" — interjeição padrão de reação a más notícias. "Oh" é a interjeição genérica em inglês para surpresa, susto, empatia.
...
1. **"Oh no, that's terrible."** — reação empática
2. **"I'm so sorry to hear that."** — condolências
3. **"That sucks."** — reação informal
4. **"What a shame!"** — decepção leve
5. **"That's a bummer."** — chatice informal

### 3. Role-play

**Cenário**: Charlotte te conta três notícias ruins. Você reage com empatia apropriada.
**Tipo**: Live Voice
**Voiced by**: `charlotte`
**Persona**: Charlotte
**Persona outfit**: `charlotte_casual`
**Time budget**: 90s
**Opening line**: "I'm having a tough week. My phone broke yesterday."
...
1. **Charlotte**: "I'm having a tough week. My phone broke yesterday."
2. **Student**: ~"Oh no, that sucks!"
3. **Charlotte**: "And my cat got sick on Monday."
4. **Student**: ~"I'm so sorry to hear that."
5. **Charlotte**: "And I missed an important deadline at work."
6. **Student**: ~"What a shame!"
7. **Charlotte**: "Yeah. Thanks for listening. Things will get better."

**Evaluation focus**:
- Empatia graduada por intensidade
- Variedade de reações
- Tom de apoio

### 4. Guided Chat

**Cenário**: Charlotte está chateada e te conta o que aconteceu. Você dá apoio.
**Voiced by**: `charlotte`
**Persona**: Charlotte
**Persona outfit**: `charlotte_casual`
**Intro (em PT-BR)**: "Charlotte teve um dia ruim. Reaja com empatia natural."
**Opening message**: "Today was awful. I missed my flight, then I lost my wallet."
...
1. **Charlotte**: "Today was awful. I missed my flight, then I lost my wallet."
2. **Student**: "Oh no, that's terrible!"
3. **Charlotte**: "Yeah, it was a disaster. I had to cancel everything."
4. **Student**: "Are you okay now?"
5. **Charlotte**: "Getting there. The bank canceled my cards already."
6. **Student**: "Let me know if you need anything."
7. **Charlotte**: "Thanks. You're a good friend."
...
> **Sub-CEFR**: A2 | **Grammar focus**: Ganhar tempo, pedir pausa, mudar de assunto
> **Markers**: [conversation]
> **Real-life context**: Você precisa pensar antes de responder, ou quer mudar de tópico na conversa.

### 1. Grammar (10 exercises)

1. **multiple_choice** — Você precisa de um segundo pra pensar. Diz:
   **Options**: Hold on. / Stop. / Silence. / No.
   **Answer**: Hold on.
   **Explanation**: "Hold on" — chunk fixo para "espere um momento". Pede pausa sem parecer rude. "Stop" / "Silence" / "No" são abruptos.

2. **multiple_choice** — Você quer mudar de assunto:
   **Options**: By the way... / In the bus... / Over the table... / At the moment...
   **Answer**: By the way...
...
1. **"Hold on a second."** — pausa curta
...
**Cenário**: Charlotte te faz três perguntas seguidas. Você usa pausas e transições naturalmente.
**Tipo**: Live Voice
**Voiced by**: `charlotte`
**Persona**: Charlotte
**Persona outfit**: `charlotte_casual`
...
- Transição natural de tópico
- Retomada após desvio

### 4. Guided Chat

**Cenário**: Charlotte faz uma pergunta complicada. Você pede pausa, depois muda de assunto.
**Voiced by**: `charlotte`
**Persona**: Charlotte
**Persona outfit**: `charlotte_casual`
...
Ao terminar M24, o aluno deve:
- Reagir mostrando interesse em vez de ficar mudo
- Expressar surpresa e descrença com variedade ("No way!", "Seriously?", "Get out!")
- Confirmar entendimento naturalmente ("Got it", "Makes sense", "I see")
- Reagir com empatia a más notícias ("Oh no", "I'm so sorry", "That sucks")
- Pedir pausa pra pensar ("Hold on", "Hang on", "Let me think")
- Mudar de tópico suavemente ("By the way", "Anyway")
- Soar engajado e natural em conversas reais

Estes chunks conversacionais conectam diretamente a I23 (tag questions + fillers Inter) e A21 (native fluency Advanced) — a fluência conversacional é construída desde Novice.
