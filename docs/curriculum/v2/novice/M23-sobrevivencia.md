...
1. **id**: 1
   **label_pt**: "Dizer o que faz quando está doente"
   **label_en**: "Say what you do when sick"
...
1. **id**: 1
   **label_pt**: "Dizer como se sente ao telefone"
   **label_en**: "Say how you feel on the phone"
